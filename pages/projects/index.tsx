...
const Projects = ({ setActive }: ProjectsProps) => {
    ...
    return (
        <>
            ...
            <div className="pt-28 px-5 md:px-20 max-w-md mx-auto md:mx-0 md:max-w-none grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                <div onClick={() => router.push('/projects/movies')} className="bg-gray-700 shadow-lg rounded-lg overflow-hidden cursor-pointer hover:-translate-y-0.5 hover:shadow-xl hover:opacity-90 transform transition duration-300">
                    <img className="w-full h-56 md:h-64 object-cover object-center" src="movie.jpg" alt="Laravel Yang Anda Mungkin Tidak Tahu" />
